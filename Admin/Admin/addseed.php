      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="card">
            ...
            <h3 class="card-title"> Addseed</h3>
          </div>
                   <form role="form">
                	<div class="class-body">
                      <div class="form-group">
                      <label for="product_id">ProductID</label>
                      <input type="text" class="form-control" id="product_id" placeholder="enter customer id"/>
                      <label for="product_name">ProductName</label>
                        ...
                        <input type="text" class="form-control" id="supplier_id" placeholder="enter occupation"/><br/>
