          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                      ...
                      <?php
                  $result=$mysqli->query("select *  from finishedproducts ") or die(mysqli_error($mysqli));
               
                  while(list($product_id,$product_name,$category_id,$quantity,$image,$price,$status)=mysqli_fetch_array($result))
                  {
                    $sql="SELECT COUNT(product_id) AS total FROM finishedproducts where status='pending'";
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                  ...
                  $result=$mysqli->query("select *  from mills  ") or die(mysqli_error($mysqli));
               
                  while(list($mill_id,$miller_id,$miller_name,$location,$status)=mysqli_fetch_array($result))
                  {
                    $sql="SELECT COUNT(mill_id) AS total FROM mills where status='pending'";
                    $result=$mysqli->query($sql);
                    $values=mysqli_fetch_assoc($result);
                    $num_rows=$values["total"];
                    echo "<h3>$num_rows</h3>";
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                  ...
                  $result=$mysqli->query("select *  from warehouse") or die(mysqli_error($mysqli));
               
                  while(list($warehouse_id,$warehouse_name,$location_date,$storekeeper_id,$storekeeper_name)=mysqli_fetch_array($result))
                  {
                    $sql="SELECT COUNT(warehouse_id) AS total FROM warehouse where status='pending'";
                    $result=$mysqli->query($sql);
                    $values=mysqli_fetch_assoc($result);
                    $num_rows=$values["total"];
                    echo "<h3>$num_rows</h3>";
...
<script src="dist/js/demo.js"></script><!-- jQuery -->
