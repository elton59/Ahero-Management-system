  ...
  if(isset($_POST['add']))
 {
    ...
    $location=$_POST['location'];
          ...
          $servername = "localhost";
            ...
            $sql=$mysqli->query("INSERT INTO mills(miller_id,miller_name,location) VALUES('$mrid','$mname','$location')") or die($mysqli->error);
            if($sql){
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="card">
            ...
            <h3 class="card-title">Add Mills</h3>
          </div>
          <div class="card-body">
          <?php
         if(isset($_POST['mrid']))
         ...
         if(isset($_POST['location']))
         {
          ...
          ?>
                   <form role="form" method="POST">
                      ...
                      <label for="farm_name">MillerID</label>
                          <input type="text" name="mrid" id="miller_id" placeholder="enter miller_id"       
                        class="form-control" required/>    </br>
                        <label for="miller_name">MillerName</label>
                        <input type="text" name="mname" id="miller_name" placeholder="enter MillerName"  class="form-control" required/><br/>
                        <label for="location">Location</label>
                        <input type="text" name="location" id="hname" placeholder="enter household name"  class="form-control"required/></br>
