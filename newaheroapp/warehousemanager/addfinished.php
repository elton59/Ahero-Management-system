  ...
  if(isset($_POST['add']))
 {
    ...
    $price=$_POST['price'];
          $servername = "localhost";
            ...
            $sql=$mysqli->query("INSERT INTO finishedproducts(product_name,category,quantity,mill_id,image,price) VALUES('$pname','$category','$quantity','$mid','$img','$price')") or die($mysqli->error);
            if($sql){
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="card">
            ...
            <h3 class="card-title">Add Finished products</h3>
          </div>
          <div class="card-body">
          <?php
          ...
          ?>
                  ...
                  <div class="class-body">
                      ...
                      <label for="product_name">ProductName</label>
                       ...
                       <input type="text" name="category"  placeholder="category"class="form-control" required/> </br>
                        <label for="quantity">Quantity</label>
                        <input type="text" name="quantity"  placeholder="enter quantity"  class="form-control" required/><br/>
                        <label for="farm_id">MillID</label>
                        <input type="text" name="mid"  placeholder="MillId"class="form-control"required/></br>
                        <label for="img">Image</label></br>
                        <input type="file" name="img" placeholder="upload image" class="form-control" required  />
                         <label for="price">Price</label></br>
                        <input type="number" name="price" placeholder="input price" class="form-control" required  />
