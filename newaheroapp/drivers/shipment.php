      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <!--card body-->
                  <div class="class-body">
                   <div class="table-responsive ps">
                    <table id="example2" class="table table-bordered table-hover" id="page1">
                      <thead>
                        <tr><th>CART_ID</th><th>PRODUCT_ID</th><th>PRODUCT_NAME</th><th>PRICE</th><th>QUANTITY</th><th>CUSTOMER_NAME</th><th>LOCATION</th><th>PHONE_NUMBER</th><th>DRIVER_NAME</th><th>STATUS</th><th>ACTION</th></tr>
                      </thead>
                      <?php
              ...
              <td> <a href='shipment.php?apshpid=$row[cart_id]' class='btn btn-info'>shipped</a>
