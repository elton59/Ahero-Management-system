...
<div class="wrapper">
 ...
 <div class="table-responsive ps">
                    <table id="example2" class="table table-bordered table-hover" id="page1">
                      ...
                      <?php
                  $result=$mysqli->query("select * from purchased")or die($mysqli->error);
                  while($row=$result->fetch_assoc())
                  {
                    ...
                    <td>".$row['farmer_name']."</td>
                     <td>".$row['mpesa_number']."</td>
                      <td>".$row['status']."</td>
                    <td> <a href='purchased.php?apfpid=$row[product_id]' class='btn btn-success'>Approve<a>
                   <a href='purchased.php? rjfpid=$row[product_id]' class='btn btn-danger'>Reject<a></td>
                    </tbody>
                    "
                  ;}
            ?>
