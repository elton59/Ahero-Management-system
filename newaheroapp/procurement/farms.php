                  ...
                  <div class="class-body">
                   <div class="table-responsive ps">
                    <table id="example2" class="table table-bordered table-hover" id="page1">
                      <thead>
                        <tr><th>FARM_ID</th><th>FARM_NAME</th><th>HOUSEHOLD_ID</th><th>HOUSEHOLD_NAME</th><th>SIZE</th></tr>
                      </thead>
                      <?php
                  $result=$mysqli->query("select * from farms where status='approved'")or die($mysqli->error);
