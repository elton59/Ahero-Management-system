        ...
        <div class="row">
          ...
          <!--card body-->
                  ...
                  while($row=$result->fetch_assoc())
                  {
                    ...
                    <td>".$row['status']."</td>
               <td> <a href='allocated.php?aid=$row[product_id]' class='btn btn-success'>Recieved<a>
...
<?php
  ...
  {
    $product_id=$_GET['aid'];
    $result = $mysqli->query("UPDATE allocated SET Status= 'received' WHERE product_id = $product_id") or die($mysqli->error);
