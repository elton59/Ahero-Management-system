        ...
        <div class="row">
          ...
          <!--card body-->
                    ...
                    <table id="example2" class="table table-bordered table-hover" id="page1">
                      <thead>
                        <tr><th>farmer_id</th><th>farmer_name</th><th>email</th><th>farm_id</th><th>farm_name</th></tr>
                      </thead>
                      <?php
                  $result=$mysqli->query("select * from farmers where status='approved'")or die($mysqli->error);
