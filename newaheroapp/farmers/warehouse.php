          ...
          <!--card body-->
                  <div class="class-body">
                    ...
                    <table id="example2" class="table table-bordered table-hover" id="page1">
                      <thead>
                        <tr><th>WarehouseID</th><th>Warehousename</th><th>Location</th><th>StorekeeperID</th><th>StorekeeperName</th></tr>
                      </thead>
                      <?php
                  $result=$mysqli->query("select * from warehouse where status='approved'")or die($mysqli->error);
