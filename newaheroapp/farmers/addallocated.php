  ...
  if(isset($_POST['add']))
 {
    ...
    $supplier=$_POST['supplier'];
          $servername = "localhost";
            ...
            $sql=$mysqli->query("INSERT INTO allocated(product_name,quantity,farmer_name) VALUES('$pname','$quantity','$fid')") or die($mysqli->error);
            if($sql){
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="card">
            ...
            <h3 class="card-title">Request for Raw products</h3>
          </div>
          <div class="card-body">
          <?php
                   ...
                   <form role="form" method="POST">
                	<div class="class-body">
                      ...
                      <label for="product_name">ProductName</label>
                        <select  name="pname" id="product_name" placeholder="enter product name" class="form-control" required/>
                        <option value="soybeans_seeds">soybeans_seeds</option>
                        <option value="watermellon_seeds">watermellon_seeds</option>
                        ...
                        <label for="farm_id">FarmerName</label>
                        <input type="text" name="fid" id="farmId" placeholder="name"  class="form-control"required/></br>
                       
                        <input type="submit" class="btn btn-success" name="add" value="request"/>
