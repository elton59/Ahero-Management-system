          ...
          <!--card body-->
                  ...
                  <div class="table-responsive ps">
                    <table id="example2" class="table table-bordered table-hover" id="page1">
                      <thead>
                        <tr><th>service_id</th><th>service_name</th><th>service_date</th><th>start_time</th><th>venue</th></tr>
                      </thead>
                      <?php
                  $result=$mysqli->query("select * from services where status='approved'")or die($mysqli->error);
