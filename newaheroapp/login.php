...
$sql = "SELECT * FROM users WHERE username = '".$uname."' AND Password = '".$password."' AND status='approved' LIMIT 1";
...
if (mysqli_num_rows($result) == 1 && $_SESSION['role']=='customer'){
echo 
				...
				if(isset($_POST['password']))
				{
					...
					<ul class="login-more p-t-190">
						<li class="m-b-8">
							...
							<a href="register_form.php" class="txt2">
							Signup
							</a>
						</li>
						...
						<li>
							...
							<a href="register_for.php" class="txt2">
							reset
							</a>
						</li>
						</li>
