...
function fetch_data()
{
  $output='';
  include('db.php');
   $result=$mysqli->query("select * from cart where $username=$_SESSION['username']")or die($mysqli->error);
...
<h3 align="center"><u>purchase items</u></h3>
...
$pdf->output('receipt report.pdf','I');
