...
<div class="table-responsive ps">
  ...
  "
      ...
      <td>". $row ['location']."</td>
      <td>". $row['status']."</td>
      <td><a href='customer.php?apcid=$row[customer_id]' class='btn btn-success'>Approve</a>
     <a href='customer.php?rjcid=$row[customer_id]' class='btn btn-danger'>Reject</a></td>
      </tr>
      <tbody>";
      ?>
